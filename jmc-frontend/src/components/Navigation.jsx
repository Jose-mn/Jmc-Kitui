        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="p-2 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-colors mr-2"
          ...
          {isOpen && (
            ...
            >
              <div className="py-4 space-y-3">
                <Link
                  to="/"
                  className="block py-2 text-slate-700 dark:text-slate-300 hover:text-purple-700 dark:hover:text-purple-400 font-medium transition"
                  onClick={closeMenu}
                >
                  HOME
                </Link>
                      ...
                      >
                        {ministries.map((item) => (
                          <Link
                            key={item.name}
                            to={item.path}
                            className="block py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-purple-700 dark:hover:text-purple-400 transition"
                            onClick={closeMenu}
                          >
                            {item.name}
                          </Link>
