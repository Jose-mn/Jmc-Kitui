      ...
      <section className="py-20 px-6 relative overflow-hidden bg-purple-50/30 dark:bg-purple-900/10 transition-colors duration-300">
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Sunday Service", time: "8:45 AM - 12:00 PM", color: "bg-purple-600", icon: Church, description: "Main worship service" },
              { title: "Prayer Meetings", time: "Tue & Thu 5:00 - 7:00 PM", color: "bg-purple-700", icon: HeartHandshake, description: "Join us in prayer" },
              { title: "Friday Nights", time: "As Announced", color: "bg-purple-500", icon: PlayCircle, description: "Special prayer services" },
            ].map((service, i) => {
                  ...
                  >
                    <Card className="border-0 shadow-xl overflow-hidden hover:shadow-2xl transition-shadow bg-white dark:bg-slate-900 dark:border dark:border-slate-800">
                      ...
                      <CardContent className="p-10">
                        ...
                        {featured.video_url && (
                          <motion.div className="flex justify-center gap-4" whileHover={{ scale: 1.05 }}>
                            <Button
