              ...
              <Card className="border-0 shadow-2xl overflow-hidden h-full group hover:shadow-3xl transition-all duration-300">
                <div className="relative h-64 md:h-80 overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6">
                    <div className="w-16 h-16 rounded-2xl bg-white/30 backdrop-blur-sm flex items-center justify-center shadow-xl border border-white/40">
                      <Eye className="w-8 h-8 text-white drop-shadow-lg" />
                    </div>
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 px-6 py-4 bg-white/10 backdrop-blur-sm border-t border-white/20">
