      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-6 text-sm">
            ...
            <Link to="/admin/login" className="text-slate-700 hover:text-purple-700 font-medium transition text-xs">
              ADMIN
            </Link>
          </div>
          ...
          {isOpen && (
            ...
            >
              <div className="py-4 space-y-3">
                ...
                <Link
                  to="/admin/login"
                  className="block py-2 text-slate-700 hover:text-purple-700 font-medium transition text-sm"
                  onClick={closeMenu}
                >
                  ADMIN
                </Link>
